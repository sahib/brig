...
\appto\chapterheadstartvskip{%
  ...
  \smash{\makebox[0pt]{%
    \textcolor{titlepagecolor}{%
      \usesizeofkomafont{chapter}\rule[-2\ht\strutbox-\dp\strutbox]{2\paperwidth}{2\baselineskip}%
}}}}
\renewcommand\chapterformat{%
  \makebox[0pt][r]{\thechapter\ \ \textcolor{titlepagefontcolor}{\smash{\rule[-\dp\strutbox]{2.5pt}{\baselineskip}}}}%
  \enskip%
}
