...
**Storage quotas:** On devices with limited storage space, a user will be able to access files
directly
...
As we are developing free software since several years now by ourselves, we are maintaining contact
