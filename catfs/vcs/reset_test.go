...
func TestResetFile(t *testing.T) {
	c.WithDummyKv(t, func(kv db.Database) {
		...
		if err := ResetFile(lkr, lastCommit, "/cat.png"); err != nil {
		...
		if err := ResetFile(lkr, initCmt, "/cat.png"); err != nil {
		...
		if err := ResetFile(lkr, head, "/cat.png"); err != nil {
