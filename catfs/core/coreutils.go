...
func Stage(lkr *Linker, repoPath string, contentHash, backendHash h.Hash, size int64, key []byte, modTime time.Time) (file *n.File, err error) {
	cachedSize := int64(-1) // negative indicates that cachedSize is unknown
...
func StageWithFullInfo(lkr *Linker, repoPath string, contentHash, backendHash h.Hash, size, cachedSize int64, key []byte, modTime time.Time) (file *n.File, err error) {
