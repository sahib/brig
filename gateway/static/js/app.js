				...
				_List_fromArray(
					[
						...
						if (_n0.$ === 'Ready') {
							...
							var message = _n0.a;
							return A5(author$project$Util$buildAlert, model.alert, author$project$Modals$Remove$AlertMsg, true, 'Oh no!', 'Could not remove directory: ' + message);
						}
					}()
					]))
			]);
		...
		body: function () {
			...
			switch (_n0.$) {
				...
				case 'LoginReady':
					return _List_fromArray(
						[
							author$project$Main$viewLoginForm(model)
						]);
				case 'LoginFailure':
					return _List_fromArray(
						[
