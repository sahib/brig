...
var author$project$Clipboard$copyToClipboard = _Platform_outgoingPort('copyToClipboard', elm$core$Basics$identity);
...
var author$project$Routes$Remotes$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var fingerprint = msg.a;
				var newModelCmd = A4(author$project$Routes$Remotes$showAlert, model, 2, author$project$Util$Info, 'Copied full fingerprint to clipboard.');
				return _Utils_Tuple2(
					newModelCmd.a,
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								elm$json$Json$Encode$string(fingerprint)),
								newModelCmd.b
							])));
		}
	});
...
var author$project$Routes$Remotes$ClipboardCopyClicked = function (a) {
	return {$: 'ClipboardCopyClicked', a: a};
};
				...
				function (t) {
					return A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								A3(elm$core$String$slice, 0, 10, t))
							]));
				},
				A2(elm$core$String$split, ':', fingerprint))));
};
var author$project$Routes$Remotes$viewFingerprintButton = function (fingerprint) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Button$button,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						author$project$Routes$Remotes$ClipboardCopyClicked(fingerprint))
					]))
			]),
		_List_fromArray(
			[
				author$project$Routes$Remotes$viewFingerprint(fingerprint)
			]));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$Routes$Remotes$viewFingerprintButton(remote.fingerprint)
								]))
						])),
					A2(
					rundis$elm_bootstrap$Bootstrap$Table$td,
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$class('text-muted remote-heading')
												]),
											_List_fromArray(
												[
													elm$html$Html$text('Name')
							...
							[
								...
								_List_fromArray(
									[
										...
										author$project$Routes$Remotes$viewMetaRow,
										'Fingerprint',
										author$project$Routes$Remotes$viewFingerprintButton(model.self.self.fingerprint))
									]))
							]))
					])),
				A2(
